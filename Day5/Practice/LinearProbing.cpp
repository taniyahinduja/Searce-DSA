/*Linear probing implementation with update*/
...
public:
    ...
    void update()
    {
        int k, newValue;
        bool flag = false;
        cout << "Enter the key whose value is to be updated" << endl;
        cin >> k;
        ...
        if (Key[hash] == k)
        {
            cout << "The old value is " << Value[hash] << endl;
            Value[hash] = newValue;
            cout << "The new value is" << Value[hash] << endl;
            flag = true;
        }
        else
        {
...
int main()
{
    ...
    do
    {
        ...
        cout << " 3: To retrieve data \n 4 : To delete data 5 : To display keys and values\n 6. To update the values" << endl;
        cin >> n;
        Hashtable H;
        switch (n)
        {
